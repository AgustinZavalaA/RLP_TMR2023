...
def all_sensors_strategy(sensor_values: tuple[int, int, int], max_distance: int, min_distance: int) -> bool:
    """
...
def any_sensor_strategy(sensor_values: tuple[int, int, int], max_distance: int, min_distance: int) -> bool:
    """
    This function is used to determine if the robot is about to collide with an obstacle.
    It returns True if the robot is about to collide with an obstacle, False otherwise.
    """
...
class DistanceSensorsControllerRaspberry(DistanceSensorsController):
    ...
    def is_about_to_collide(self, strategy: Callable[[tuple[int, int, int], int, int], bool]) -> bool:
        ...
        return strategy(sensor_data, self._max_distance, self._min_distance)
